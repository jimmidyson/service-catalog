...
func NewStorage(optsGetter generic.RESTOptionsGetter) (serviceBrokers, serviceBrokerStatus rest.Storage, err error) {
	store := registry.Store{
		NewFunc:                  func() runtime.Object { return &servicecatalog.ServiceBroker{} },
		NewListFunc:              func() runtime.Object { return &servicecatalog.ServiceBrokerList{} },
		PredicateFunc:            Match,
